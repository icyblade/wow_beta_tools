...
patcher = {
    'x86': {
        'Fix Green Texture': (
            'F64518018B35(?P<a>[0-9A-F]{6})0159648B0D2C0000008945148955FC8B34B1C786080000000200000074(?P<b>[0-9A-F]{2})',
            'F64518008B35\g<a>0159648B0D2C0000008945148955FC8B34B1C786080000000200000075\g<b>',
            'F64518008B35(?P<a>[0-9A-F]{6})0159648B0D2C0000008945148955FC8B34B1C786080000000200000075(?P<b>[0-9A-F]{6})'
        ),
        'Anti-crash': (
    ...
    'x64': {
        'Fix Green Texture': (
            'F6842480000000018B15(?P<a>[0-9A-F]{6})0165488B0C255800000041BD10000000488BE8488B3CD141C744(?P<b>[0-9A-F]{2})00020000000F84(?P<c>[0-9A-F]{2})000000',
            'F6842480000000008B15\g<a>0165488B0C255800000041BD10000000488BE8488B3CD141C744\g<b>00020000000F85\g<c>000000',
            'F6842480000000008B15(?P<a>[0-9A-F]{6})0165488B0C255800000041BD10000000488BE8488B3CD141C744(?P<b>[0-9A-F]{2})00020000000F85(?P<c>[0-9A-F]{2})000000',
        ),
        'Anti-crash': (
